export enum Routes {
  ...
  FUND_MANAGER_INVITATIONS = `${Routes.FUND_MANAGER}/invitations`,

  FUND_MANAGER_NEW_LIMITED_PARTNER = `${Routes.FUND_MANAGER}/limited-partners/new-limited-partner`,
  FUND_MANAGER_LIMITED_PARTNER = `${Routes.FUND_MANAGER}/funds/:fundId/limited-partners/:limitedPartnerId`,
  ...
  PROSPECT_TRACKER_PATH = `${Routes.APPS}/prospect-tracker`,
  PROSPECT_TRACKER_PROSPECTS = `${Routes.PROSPECT_TRACKER_PATH}/prospects`,
  PROSPECT_TRACKER_NEW = `${Routes.PROSPECT_TRACKER_PATH}/new`,
  PROSPECT_TRACKER_PROSPECT = `${Routes.PROSPECT_TRACKER_PATH}/prospect`,
  PROSPECT_TRACKER_COMPANY = `${Routes.PROSPECT_TRACKER_PATH}/company/:companyId`,
  PROSPECT_TRACKER_HEAT = `${Routes.PROSPECT_TRACKER_PATH}/heat`,
  PROSPECT_TRACKER_UPDATES = `${Routes.PROSPECT_TRACKER_PATH}/updates`,
}
